...
- **Not built yet (the real gaps):** the **economy** (Talents/packs/Fragments/ownership — "Packs" is a stub, the whole collection is unlocked); **Scroll Study**; the **sacred Cross/Resurrection interlude** (Law 5 — campaign is 4 combat chapters only); **iOS/Capacitor** wrapper. See `STATUS.md` and `docs/06-decisions-log.md`.
